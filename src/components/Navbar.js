...
function Navbar (props){
	...
	function SubstringAddressMobile () {
		if(props.account){
			...
			// if network is wrong display 'wrong network'
					...
					return(<div className = 'addressContainerMobile'><p className = 'addressText'>Wrong Network</p></div>)
			}
		}
		else {
			return(<button onClick = {props.connectWallet} className = 'connectWalletMobile'> <div className = 'connectWalletText'>Connect Wallet</div> </button>)
		}
}
    ...
    return(
			<nav className = 'navbar'>
				...
				<a exact className = 'logo' href = 'https://nftrees.com/'> <img className = 'logoImage' src = {logo} alt = 'logo' height = {50}/> <div className = 'landingTitle'>NF<div className = 'split'/>Trees</div></a>
				...
				<div className = 'menu'>
					...
					<a exact activeClassName = "active-navbar-Link" className = "navbar-Link" href = 'https://offsetra.com/profile/NFTrees' rel='noreferrer' target = '_blank'>Portfolio<sup>↗</sup></a>
				...
				<Menu right>
					...
					<NavLink exact className = "menu-item" to = '/'>Plant</NavLink>
					<NavLink exact className = "menu-item" to = '/dashboard'>Dashboard</NavLink>
					<a className="menu-item" href="https://offsetra.com/profile/NFTrees" target = "_blank"><FaTree style = {{marginRight: '10px'}}/>Offsetra</a>
